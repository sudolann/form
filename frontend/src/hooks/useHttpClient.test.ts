...
describe('useHttpClient - GET', () => {
  it('should loading the app and should return data', async () => {
    const { result } = renderHook(() => useHttpClient('https://jsonplaceholder.typicode.com/posts/'));
  ...
  it('Should return an error', async () => {
    const { result } = renderHook(() => useHttpClient('https://jsonplaceholder.typicode.com/post/'));
    await act(() => result.current.executeRequest());
